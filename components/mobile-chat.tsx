...
export function MobileChat({ onBackClick }: MobileChatProps) {
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-zinc-900/95 backdrop-blur-sm">
        <div className="flex items-center gap-3">
          ...
          <div className="w-12 h-12 rounded-full overflow-hidden bg-zinc-800">
            <img src="/images/design-mode/c.ai.png" alt="GenZombie" className="w-full h-full object-cover" />
          </div>
          <div>
            <h1 className="font-semibold text-white text-sm">GenZombie</h1>
            <p className="text-xs text-gray-400">By @angiiirl</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
